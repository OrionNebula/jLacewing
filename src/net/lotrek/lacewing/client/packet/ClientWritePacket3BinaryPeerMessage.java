...
public class ClientWritePacket3BinaryPeerMessage extends ClientWritePacket
{
	private byte[] data;
	private int subChannel, channel, peer;
	
	public ClientWritePacket3BinaryPeerMessage(int subChannel, int channel, int peer, byte[] data)
	{
