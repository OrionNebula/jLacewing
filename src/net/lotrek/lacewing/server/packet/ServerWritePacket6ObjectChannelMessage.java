...
public class ServerWritePacket6ObjectChannelMessage extends ServerWritePacket
{
	private int subChannel, channel, peer;
	private byte[] data;
	
	public ServerWritePacket6ObjectChannelMessage(int subChannel, int channel, int peer, byte[] data)
	{
