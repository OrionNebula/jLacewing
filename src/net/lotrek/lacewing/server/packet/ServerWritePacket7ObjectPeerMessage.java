...
public class ServerWritePacket7ObjectPeerMessage extends ServerWritePacket
{
	private int subChannel, channel, peer;
	private byte[] data;
	
	public ServerWritePacket7ObjectPeerMessage(int subChannel, int channel, int peer, byte[] data)
	{
